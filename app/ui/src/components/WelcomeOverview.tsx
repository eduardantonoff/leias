...
import { FibonacciIllustration } from './FibonacciIllustration';
...
export function Overview() {
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-6xl items-center justify-center px-6 py-8">
      <div className="empty-chat-shell grid w-full max-w-5xl items-stretch gap-10 py-6 md:grid-cols-[minmax(0,1fr)_490px] md:py-10">
        <div className="grid h-[420px] min-w-0 max-w-xl grid-rows-[auto_minmax(0,1fr)] text-left">
          <div>
            <h1 className="max-w-xl text-3xl leading-tight tracking-tight text-ink-strong md:text-5xl">
              STEM tutor
            </h1>
          </div>
          ...
          <div className="mt-5 max-w-xl overflow-hidden">
            <p className="max-w-xl text-base leading-7 text-ink-soft md:text-lg">
              Turns real course materials into grounded, step-by-step learning paths for individualized support.
            </p>
            <div className="mt-6 text-xs uppercase tracking-[0.18em] text-muted-foreground/65">
              Powered by Gemma 4 26B
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="mt-3 min-h-[5.5rem] max-w-xl">
                <AnimatePresence mode="wait">
                  <motion.p
                    ...
                    className="max-w-xl text-base leading-7 text-ink-soft md:text-lg"
                  >
                    {activeItem.line}
                  </motion.p>
                </AnimatePresence>
